...
<div class="toppic">
    <div class="am-container-1">
        ...
        <div class="right toppic-progress">
            ...
            <span><a href="/about/index" class="w-white">关于我们</a></span>
        </div>
    </div>
</div>
...
<div class=" am-container-1">
    ...
    <div class="office-space">
        <div class="cam-u-lg-6 am-u-md-6 am-u-sm-12">
            <img src="/static/img/space-1.png"/>
        </div>
        <div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
            <img src="/static/img/space-2.png"/>
        </div>
        <div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
            <img src="/static/img/space-3.png"/>
        </div>
        <div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
            <img src="/static/img/space-4.png"/>
        </div>
        <div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
            <img src="/static/img/space-5.png"/>
        </div>
        <div class="clear"></div>
    </div>
        ...
        <div class="contact-us">
            ...
            <div class="am-u-lg-6 am-u-md-6 am-u-sm-12">
                <ul class="contact-add">
                    <li>
                        <div><i class=" am-icon-map-marker"></i><span class="contact-add-1">武汉市洪山区街道口阜华大厦1105</span>
                        </div>
                    </li>
                    <li>
